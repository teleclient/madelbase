...
function updSummary(array $update, array $peerInfo = null): string
{
    ...
    $peerID    =  $peerType === 'peerUser'   ? $update['message']['to_id']['user_id'] : ($peerType === 'peerChat'   ? $update['message']['to_id']['chat_id'] : ($peerType === 'peerChannel' ? ($update['message']['to_id']['channel_id']) : 0));
